...
- Blog: MDX, 4 launch articles from plan §6.2.6, 900–1300 words each, `Article` JSON-LD, related-service links.
- Re-runnable; minor issues → `KNOWN-ISSUES.md`; stop only per §4.4.

Exit: `/nosotros/ /contacto/ /precios/ /privacidad/ /terminos/ /blog/` + 4 article URLs return 200 with unique metadata;
